...
class ClinicQueueApp:
    def __init__(self, root):
        ...
        tk.Radiobutton(frame, text="Emergency", variable=self.priority_var, value="Emergency").grid(row=3, column=1, sticky="w")
        tk.Radiobutton(frame, text="Normal", variable=self.priority_var, value="Normal").grid(row=3, column=2, sticky="w")
        
        btn_frame = tk.Frame(root)
        btn_frame.pack(pady=5)
        
        tk.Button(btn_frame, text="Add Patient", command=self.add_patient_gui, width=15, bg="lightblue").grid(row=0, column=0, padx=5)
        tk.Button(btn_frame, text="Process Next", command=self.process_next_gui, width=15, bg="lightgreen").grid(row=0, column=1, padx=5)
        ...
        tk.Button(btn_frame, text="Exit", command=self.exit_app, width=15, bg="red", fg="white").grid(row=0, column=4, padx=5)
